...
* Implements a new optimizer (Enos).
...
Figure 1. Enos vs. a well-tuned AdamW.
![enos](img/fig_enos.png)

---

## Enos optimizer

For this training scenario, Enos has the following properties:
...
Enos can be thought of as a second way of smoothing spectral steepest descent, with a different set of memory and runtime tradeoffs
compared to Shampoo.

### Name

* stochastic gradient dEscent with Nesterov momentum post-Orthogonalized by quintic non-converging newton-Schulz iterations
* Adam's grandson
...
```
@software{enosnanogpt2024,
    author={Jordan, Keller},
    title={Enos-NanoGPT},
    url={https://github.com/KellerJordan/Enos-NanoGPT},
    version={0.1.0},
    year = {2024}
}
```
